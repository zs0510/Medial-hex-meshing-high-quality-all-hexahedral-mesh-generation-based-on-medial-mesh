...
//#define static float name (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
//                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
//                                     const Eigen::Vector3f& p7, const void* arg)(name) static float name (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
//                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
//                                     const Eigen::Vector3f& p7, const void* arg)

typedef float (quality_measure_fun) (const Eigen::Vector3f&, const Eigen::Vector3f&, const Eigen::Vector3f&, const Eigen::Vector3f&, 
...
inline
void norms(const Eigen::Vector3f vec[], const int size, float norms[])
{
...
inline
void hex_edges(const Eigen::Vector3f & p0, const Eigen::Vector3f & p1, const Eigen::Vector3f & p2, const Eigen::Vector3f & p3,
               const Eigen::Vector3f & p4, const Eigen::Vector3f & p5, const Eigen::Vector3f & p6, const Eigen::Vector3f & p7,
               Eigen::Vector3f L[], const bool normalized)
{
...
inline
void hex_principal_axes(const Eigen::Vector3f & p0, const Eigen::Vector3f & p1, const Eigen::Vector3f & p2, const Eigen::Vector3f & p3,
                        const Eigen::Vector3f & p4, const Eigen::Vector3f & p5, const Eigen::Vector3f & p6, const Eigen::Vector3f & p7,
                        Eigen::Vector3f X[], const bool normalized)
{
...
inline
void hex_cross_derivatives(const Eigen::Vector3f & p0, const Eigen::Vector3f & p1, const Eigen::Vector3f & p2, const Eigen::Vector3f & p3,
                           const Eigen::Vector3f & p4, const Eigen::Vector3f & p5, const Eigen::Vector3f & p6, const Eigen::Vector3f & p7,
                           Eigen::Vector3f XX[], const bool normalized)
{
...
inline
void hex_diagonals(const Eigen::Vector3f & p0, const Eigen::Vector3f & p1, const Eigen::Vector3f & p2, const Eigen::Vector3f & p3,
                   const Eigen::Vector3f & p4, const Eigen::Vector3f & p5, const Eigen::Vector3f & p6, const Eigen::Vector3f & p7,
                   Eigen::Vector3f D[], const bool normalized)
{
    D[0] = p6 - p0;
    D[1] = p7 - p1;
    D[2] = p4 - p2;
...
inline
void hex_subtets(const Eigen::Vector3f L[], const Eigen::Vector3f X[], const int id, Eigen::Vector3f tet[])
{
    switch(id)
    {
...
inline
float determinant(const Eigen::Vector3f & col0, const Eigen::Vector3f & col1, const Eigen::Vector3f & col2)
{
...
inline
float frobenius(const Eigen::Vector3f & col0, const Eigen::Vector3f & col1, const Eigen::Vector3f & col2)
{
...
static float diagonal (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, 
                      const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, 
                      const Eigen::Vector3f& p7, const void* /*arg*/)
{
    Eigen::Vector3f D[4];
...
static float dimension (const Eigen::Vector3f& /*p0*/, const Eigen::Vector3f& /*p1*/, const Eigen::Vector3f& /*p2*/,
                       const Eigen::Vector3f& /*p3*/, const Eigen::Vector3f& /*p4*/, const Eigen::Vector3f& /*p5*/, const Eigen::Vector3f& /*p6*/, 
                       const Eigen::Vector3f& /*p7*/, const void* /*arg*/)
{
    return -1;
...
static float distortion (const Eigen::Vector3f& /*p0*/, const Eigen::Vector3f& /*p1*/, const Eigen::Vector3f& /*p2*/,
                        const Eigen::Vector3f& /*p3*/, const Eigen::Vector3f& /*p4*/, const Eigen::Vector3f& /*p5*/, const Eigen::Vector3f& /*p6*/, 
                        const Eigen::Vector3f& /*p7*/, const void* /*arg*/)
{
    return -1;
...
static float edge_ratio (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
    Eigen::Vector3f L[12];
...
static float jacobian (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
    Eigen::Vector3f L[12];
...
static float maximum_edge_ratio (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
    Eigen::Vector3f X[3];
...
static float maximum_aspect_frobenius (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
    Eigen::Vector3f L[12];
...
static float mean_aspect_frobenius (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
    Eigen::Vector3f L[12];
...
static float oddy (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
...
static float relative_size_squared (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* arg)
{
...
static float scaled_jacobian (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
    Eigen::Vector3f L[12];
...
static float shape (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
...
static float shape_and_size (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* arg)
{
...
static float shear (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
    Eigen::Vector3f L[12];
...
static float shear_and_size (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* arg)
{
    return relative_size_squared(p0,p1,p2,p3,p4,p5,p6,p7,arg) *
...
static float skew (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
    Eigen::Vector3f X[3];
...
static float stretch (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
...
static float taper (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
    Eigen::Vector3f X[3];
...
static float volume (const Eigen::Vector3f& p0, const Eigen::Vector3f& p1, const Eigen::Vector3f& p2, \
                                     const Eigen::Vector3f& p3, const Eigen::Vector3f& p4, const Eigen::Vector3f& p5, const Eigen::Vector3f& p6, \
                                     const Eigen::Vector3f& p7, const void* /*arg*/)
{
    Eigen::Vector3f X[3];
