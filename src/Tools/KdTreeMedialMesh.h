...
namespace MeshKernel {
	...
	class iGameKdTreeMedialMesh {
	public:
		iGameKdTreeMedialMesh(SkeletalMesh _mesh, unsigned int max_faces = 10, unsigned int max_depth = 30);
		...
		double get_radius(MeshKernel::iGameVertex& v);
