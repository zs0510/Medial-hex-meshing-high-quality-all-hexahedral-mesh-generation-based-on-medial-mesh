...
//   computing, such as computer graphics (CG), computer-aided design (STLModel),  //
...
public:
    ...
    //   These informations are provided by STLModel libraries.
    typedef struct {
        REAL uv[2];
        int tag;
        int type; // 0, 1, or 2.
    ...
    bool load_off_str(std::string& data);
...
//============================================================================//
    ...
    // TET_PI is the ratio of a circle's circumference to its diameter.
    static REAL TET_PI;
...
//============================================================================//
    ...
    void initializetetgenmesh()
    {
        ...
        samples = 0l;
        randomseed = 1l;
        minfaceang = minfacetdihed = TET_PI;
        cos_facet_separate_ang_tol = cos(179.9/180.*TET_PI);
        cos_collinear_ang_tol = cos(179.9/180.*TET_PI);
        tetprism_vol_sum = 0.0;
...
std::string  tetrahedralize_str(tetgenbehavior *b, tetgenio *in, tetgenio *out,
                    tetgenio *addin = NULL, tetgenio *bgmin = NULL);

#ifdef TETLIBRARY
void tetrahedralize(char *switches, tetgenio *in, tetgenio *out,
                    tetgenio *addin = NULL, tetgenio *bgmin = NULL);
std::string tetgen_main(std::string off_data);
