...
class HexMeshing_FaceSkeleton {// 通过直接读入四边形网格来生成面上的六面体
public:
	HexMeshing_FaceSkeleton(SkeletalMesh& _sklmesh, MeshKernel::VolumeMesh& _hexmesh): hexmesh(_hexmesh), sklmesh(_sklmesh) {}
